Meteor.methods({
  ...
  ReadXLSX: function(doc) {
	...
	var workbook = excel.readFile( basepath+'files/Marcas.xlsx'); 
	var yourSheetsName = workbook.SheetNames;
	console.log("Get the 1st Sheet Name (remember is an array): " + workbook.SheetNames[0]);
	console.log("Get Some Cell from it: " + workbook.Sheets[yourSheetsName[0]]['H3'].v);
	console.log(workbook.Sheets[yourSheetsName[0]]['H3'].v);
